...
as siblings: Segoe UI typography, a subdued neutral palette, accent
blue for primary actions. The stylesheet is applied once via
:func:`apply_global_style` from the app bootstrap; the QSS body is
kept as a parallel copy across the three suite tools (Inscription,
CaseForge, CaseGuide) so each PyInstaller build stays
self-contained.
"""
