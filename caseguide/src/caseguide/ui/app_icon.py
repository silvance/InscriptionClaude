...
Same drawing technique as Inscription / CaseForge — rounded accent
square with a serif glyph — but the letter is **G** so the three
suite apps are distinguishable in the taskbar at a glance.
"""
...
def _render(size: int, p: Palette) -> QPixmap:
    ...
    try:
        ...
        painter.drawText(body, Qt.AlignmentFlag.AlignCenter, "G")
    finally:
        painter.end()
    return pm
