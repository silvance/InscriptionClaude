...
function Invoke-Test {
    ...
    Step "pytest" {
        pytest --cov=caseguide --cov-report=term
    }
}

function Invoke-Run {
    Step "python -m caseguide" { python -m caseguide }
}
...
function Invoke-Build {
    ...
    Write-Host ""
    Write-Host "Build output: dist\CaseGuide\CaseGuide.exe" -ForegroundColor Green
}
