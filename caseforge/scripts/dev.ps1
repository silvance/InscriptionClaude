...
function Invoke-Test {
    ...
    Step "pytest" {
        pytest --cov=caseforge --cov-report=term
    }
}

function Invoke-Run {
    Step "python -m caseforge" { python -m caseforge }
}
...
function Invoke-Build {
    ...
    Write-Host ""
    Write-Host "Build output: dist\CaseForge\CaseForge.exe" -ForegroundColor Green
}
